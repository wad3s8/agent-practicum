...
public class OrchestratorService {
    ...
    private static final String SYSTEM_PROMPT = """
            ...
            - CONFERENCE_INFO: пользователь предоставляет транскрипт или заметки с конференции/переговоров и хочет извлечь информацию или задать вопрос по содержанию
