...
public class TaskAssignmentHandler {
    ...
    private static final String EXTRACT_PROMPT = """
            ...
            - assigneeName: если в тексте есть "для [имя]", "на [имя]", "назначь [имя]" — это исполнитель; если не указан — null
              ВАЖНО: имя исполнителя приводи в именительный падеж (кто?), не в родительный (кого?)
              Примеры: "для Утробина" -> "Утробин", "для Ивана Петрова" -> "Иван Петров", "на Марию" -> "Мария"
            Пример запроса: "Создай задачу Настроить CI для Ивана в проекте PROJ"
